...
public class Spel {
	...
	public static void meny() {
		...
		input = new Scanner(System.in); // Startar scanner
		...
		/**
		 * låter användaren gissa och kollar om gissning är över eller under eller rätt.
		 */
		while (on) {
			guess = input.nextInt();
			count++;
	...
	/**
	 * Kollar ifall användaren vill köra igen och skriver ut vinst meddelandet
	 * @param count
	 */
	...
	/**
	 * Skriver ut ett meddelande om användaren gissade mer än 10 gånger
	 * @param count
	 */
